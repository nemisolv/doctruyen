...
import { ActionStory } from "@/components/story/action-story";
                            ...
                            <TableBody>
                                {stories.map(story => (
                                    <TableRow key={story._id.toString()}>
                                        ...
                                        <TableCell>
                                            <Badge variant={story.status === 'Ongoing' ? 'default' : story.status === 'Completed' ? "secondary" : "outline"}>
                                                {story.status}
                                            </Badge>
                                        </TableCell>
                                        <TableCell >
                                        ...
                                        <TableCell>
                                           <ActionStory _id={story._id.toString()}/>
                                        </TableCell>
                                    </TableRow>
                                ))}
